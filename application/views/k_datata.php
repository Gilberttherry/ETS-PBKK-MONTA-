                        ...
                        <table id="" class="table table-bordered table-striped">
                            ...
                            <?php foreach($proposal->result() as $p){ ?>
                                ...
                                <td><button type="button" class="btn btn-block btn-black" data-toggle="modal"
                                    ...
                                    <td><?php echo'<span class="badge bg-black">'.$p->r_nama.'</span>';?></td>
                                    <td><?php if($p->t_status=="Tunggu"){
                                    echo '<span class="badge bg-black">Tunggu</span>';
                                 }elseif($p->t_status=="Proses Sidang"){
                                    echo ' <span class="badge bg-black">Proses Sidang</span>';
                                 }elseif($p->t_status=="Selesai"){
                                    echo ' <span class="badge bg-black">Selesai</span>'; }?></td>
                                    <td> <?php echo'<span class="badge bg-black">'.$p->t_nilai.'</span>';?></td>
                    </div>
                    <!-- /.box-body -->
                    </tr>
                    <?php } ?>
