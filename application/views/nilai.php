                        ...
                        <table id=" " class="table table-bordered table-striped">
                            ...
                            <?php foreach($proposal->result() as $p){ ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url().'datata/download/'.$p->t_file;?>">file TA</a></td>
                                    <td><a href="<?php echo base_url().'datata/download/'.$p->bimbingan_file;?>">file bimbingan</a></td>
                                    <td><span class="badge bg-black"><?php echo' '.$p->r_nama.' '?></span></td>
                                    <td><button type="button" class="btn btn-block btn-danger" data-toggle="modal"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="subimt" class="btn btn-danger">Simpan</button>
                            </div>
                            </form>
                        </div>
                        <!-- /.modal-content -->
